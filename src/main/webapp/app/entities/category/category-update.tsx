        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('shoppingApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('shoppingApp.category.sortOrder')}
              ...
              />
              <ValidatedField
                label={translate('shoppingApp.category.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('shoppingApp.category.dateModified')}
              ...
              />
              <ValidatedField
                label={translate('shoppingApp.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('shoppingApp.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('shoppingApp.category.parent')}
                type="select"
              >
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField
                label={translate('shoppingApp.category.product')}
                id="category-product"
                data-cy="product"
                type="select"
                multiple
